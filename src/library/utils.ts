...
export function getEnv(name: string, defaultValue: string | undefined = undefined): string {
...
export function validateString<T extends string>(val: string, validValues: readonly string[]): T {
